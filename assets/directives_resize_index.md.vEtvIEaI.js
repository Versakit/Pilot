const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.At9nQEz8.js","assets/chunks/framework.CTmPMVNO.js"])))=>i.map(i=>d[i]);
import{p,D as k,v as o,V as c,C as g,c as m,o as u,j as s,ah as F,G as e,ag as y,a as l,ai as b,k as a,w as h,aj as v}from"./chunks/framework.CTmPMVNO.js";import{O as E,E as C}from"./chunks/index.BwfnqG_-.js";const f=`<script setup lang="ts">
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h3 id="注意事项" tabindex="-1">注意事项 <a class="header-anchor" href="#注意事项" aria-label="Permalink to &quot;注意事项&quot;">​</a></h3><ol><li>元素必须具有定位属性（非 static）</li><li>支持八个方向的大小调整：上、下、左、右、左上、右上、左下、右下</li><li>可以限制最小和最大尺寸</li><li>拖拽时会实时触发 onResize 回调</li><li>调整手柄会自动创建和移除</li><li>支持自定义调整手柄的样式</li></ol>`,7))])}}});export{B as __pageData,w as default};
